...
class CognitiveServicesKwargs(TypedDict, total=False):
    ...
    roles: Union[Parameter[List[Union[str, 'RoleAssignment']]], List[Union[Parameter[Union[str, 'RoleAssignment']], 'RoleAssignment', Literal['Cognitive Services Contributor', 'Cognitive Services Custom Vision Contributor', 'Cognitive Services Custom Vision Deployment', 'Cognitive Services Custom Vision Labeler', 'Cognitive Services Custom Vision Reader', 'Cognitive Services Custom Vision Trainer', 'Cognitive Services Data Reader (Preview)', 'Cognitive Services Face Recognizer', 'Cognitive Services Immersive Reader User', 'Cognitive Services Language Owner', 'Cognitive Services Language Reader', 'Cognitive Services Language Writer', 'Cognitive Services LUIS Owner', 'Cognitive Services LUIS Reader', 'Cognitive Services LUIS Writer', 'Cognitive Services Metrics Advisor Administrator', 'Cognitive Services Metrics Advisor User', 'Cognitive Services OpenAI Contributor', 'Cognitive Services OpenAI User', 'Cognitive Services QnA Maker Editor', 'Cognitive Services QnA Maker Reader', 'Cognitive Services Speech Contributor', 'Cognitive Services Speech User', 'Cognitive Services User', 'Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'User Access Administrator']]]]
    """Array of role assignments to create."""
    user_roles: Union[Parameter[List[Union[str, 'RoleAssignment']]], List[Union[Parameter[Union[str, 'RoleAssignment']], 'RoleAssignment', Literal['Cognitive Services Contributor', 'Cognitive Services Custom Vision Contributor', 'Cognitive Services Custom Vision Deployment', 'Cognitive Services Custom Vision Labeler', 'Cognitive Services Custom Vision Reader', 'Cognitive Services Custom Vision Trainer', 'Cognitive Services Data Reader (Preview)', 'Cognitive Services Face Recognizer', 'Cognitive Services Immersive Reader User', 'Cognitive Services Language Owner', 'Cognitive Services Language Reader', 'Cognitive Services Language Writer', 'Cognitive Services LUIS Owner', 'Cognitive Services LUIS Reader', 'Cognitive Services LUIS Writer', 'Cognitive Services Metrics Advisor Administrator', 'Cognitive Services Metrics Advisor User', 'Cognitive Services OpenAI Contributor', 'Cognitive Services OpenAI User', 'Cognitive Services QnA Maker Editor', 'Cognitive Services QnA Maker Reader', 'Cognitive Services Speech Contributor', 'Cognitive Services Speech User', 'Cognitive Services User', 'Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'User Access Administrator']]]]
...
CognitiveServicesAccountResourceType = TypeVar('CognitiveServicesAccountResourceType', default='CognitiveServicesAccountResource')
_DEFAULT_COGNITIVE_SERVICES: 'CognitiveServicesAccountResource' = {
    'name': GLOBAL_PARAMS['defaultName'],
    'location': GLOBAL_PARAMS['location'],
    'tags': GLOBAL_PARAMS['azdTags']
}
_DEFAULT_COGNITIVE_SERVICES_EXTENSIONS: ExtensionResources = {
...
_DEFAULT_AI_SERVICES_EXTENSIONS: ExtensionResources = {
    'managed_identity_roles': ['Cognitive Services OpenAI Contributor', 'Cognitive Services OpenAI User'],
    'user_roles': ['Cognitive Services OpenAI Contributor', 'Cognitive Services OpenAI User']
}
