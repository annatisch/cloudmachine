...
output AZURE_BLOBS_ID string = test_module.outputs.AZURE_BLOBS_ID
output AZURE_BLOBS_NAME string = test_module.outputs.AZURE_BLOBS_NAME
output AZURE_BLOBS_RESOURCE_GROUP string = test_module.outputs.AZURE_BLOBS_RESOURCE_GROUP
