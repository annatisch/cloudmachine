...
output AZURE_TABLES_ID string = test_module.outputs.AZURE_TABLES_ID
output AZURE_TABLES_NAME string = test_module.outputs.AZURE_TABLES_NAME
output AZURE_TABLES_RESOURCE_GROUP string = test_module.outputs.AZURE_TABLES_RESOURCE_GROUP
