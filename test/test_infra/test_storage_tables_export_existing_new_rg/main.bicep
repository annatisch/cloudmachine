...
output AZURE_TABLES_ID_STORAGETEST string = test_module.outputs.AZURE_TABLES_ID_STORAGETEST
output AZURE_TABLES_NAME_STORAGETEST string = test_module.outputs.AZURE_TABLES_NAME_STORAGETEST
output AZURE_TABLES_RESOURCE_GROUP_STORAGETEST string = test_module.outputs.AZURE_TABLES_RESOURCE_GROUP_STORAGETEST
