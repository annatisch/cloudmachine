...
output AZURE_BLOBS_ID_STORAGETEST string = test_module.outputs.AZURE_BLOBS_ID_STORAGETEST
output AZURE_BLOBS_NAME_STORAGETEST string = test_module.outputs.AZURE_BLOBS_NAME_STORAGETEST
output AZURE_BLOBS_RESOURCE_GROUP_STORAGETEST string = test_module.outputs.AZURE_BLOBS_RESOURCE_GROUP_STORAGETEST
